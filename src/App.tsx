  ...
  return (
    <div className="graph-container">
      ...
      <svg className="supply-diagram" viewBox="0 0 950 620" role="img" aria-label="サプライチェーン可視化">
        ...
        <g className={nodeClass('sup-servo', ['factory'])} onMouseEnter={() => setHoverId('sup-servo')} onMouseLeave={() => setHoverId(null)} transform="translate(130, 115)"><circle r="30" fill="#ffffff" stroke="#3b82f6" strokeWidth={hoverId === 'sup-servo' ? 4 : 2.5} /><text className="supply-icon" y="9" textAnchor="middle" fill="#3b82f6">widgets</text><text className="supply-label" y="54" textAnchor="middle">サーボモーター</text><text className="supply-sublabel" y="72" textAnchor="middle">京都</text></g>
        <g className={nodeClass('sup-gear', ['factory'])} onMouseEnter={() => setHoverId('sup-gear')} onMouseLeave={() => setHoverId(null)} transform="translate(130, 260)"><circle r="30" fill="#ffffff" stroke="#3b82f6" strokeWidth={hoverId === 'sup-gear' ? 4 : 2.5} /><text className="supply-icon" y="9" textAnchor="middle" fill="#3b82f6">widgets</text><text className="supply-label" y="54" textAnchor="middle">波動歯車減速機</text><text className="supply-sublabel" y="72" textAnchor="middle">長野・諏訪</text></g>
        <g className={nodeClass('sup-alu', ['factory'])} onMouseEnter={() => setHoverId('sup-alu')} onMouseLeave={() => setHoverId(null)} transform="translate(130, 380)"><circle r="30" fill="#ffffff" stroke="#3b82f6" strokeWidth={hoverId === 'sup-alu' ? 4 : 2.5} /><text className="supply-icon" y="9" textAnchor="middle" fill="#3b82f6">widgets</text><text className="supply-label" y="54" textAnchor="middle">アルミ鋳物</text><text className="supply-sublabel" y="72" textAnchor="middle">三重・四日市</text></g>
        <g className={nodeClass('sup-pcb', ['factory'])} onMouseEnter={() => setHoverId('sup-pcb')} onMouseLeave={() => setHoverId(null)} transform="translate(130, 500)"><circle r="30" fill="#ffffff" stroke="#3b82f6" strokeWidth={hoverId === 'sup-pcb' ? 4 : 2.5} /><text className="supply-icon" y="9" textAnchor="middle" fill="#3b82f6">widgets</text><text className="supply-label" y="54" textAnchor="middle">制御基板</text><text className="supply-sublabel" y="72" textAnchor="middle">台湾・新竹</text></g>
        <g className={nodeClass('factory', ['sup-servo', 'sup-gear', 'sup-alu', 'sup-pcb', 'log-yard', 'log-service'])} onMouseEnter={() => setHoverId('factory')} onMouseLeave={() => setHoverId(null)} transform="translate(430, 320)"><circle r="30" fill="#ffffff" stroke="#f97316" strokeWidth={hoverId === 'factory' ? 4 : 2.5} /><text className="supply-icon" y="9" textAnchor="middle" fill="#f97316">home_work</text><text className="supply-label" y="54" textAnchor="middle">本社工場</text><text className="supply-sublabel" y="72" textAnchor="middle">栃木・宇都宮</text></g>
        <g className={nodeClass('log-yard', ['factory', 'cus-auto', 'cus-elec', 'cus-gen'])} onMouseEnter={() => setHoverId('log-yard')} onMouseLeave={() => setHoverId(null)} transform="translate(640, 185)"><circle r="30" fill="#ffffff" stroke="#10b981" strokeWidth={hoverId === 'log-yard' ? 4 : 2.5} /><text className="supply-icon" y="9" textAnchor="middle" fill="#10b981">local_shipping</text><text className="supply-label" y="54" textAnchor="middle">出荷ヤード</text><text className="supply-sublabel" y="72" textAnchor="middle">栃木・宇都宮</text></g>
        <g className={nodeClass('log-service', ['factory', 'cus-auto', 'cus-gen'])} onMouseEnter={() => setHoverId('log-service')} onMouseLeave={() => setHoverId(null)} transform="translate(640, 420)"><circle r="30" fill="#ffffff" stroke="#10b981" strokeWidth={hoverId === 'log-service' ? 4 : 2.5} /><text className="supply-icon" y="9" textAnchor="middle" fill="#10b981">local_shipping</text><text className="supply-label" y="54" textAnchor="middle">サービスセンター</text><text className="supply-sublabel" y="72" textAnchor="middle">全国 12拠点</text></g>
        <g className={nodeClass('cus-auto', ['log-yard', 'log-service'])} onMouseEnter={() => setHoverId('cus-auto')} onMouseLeave={() => setHoverId(null)} transform="translate(820, 145)"><circle r="30" fill="#ffffff" stroke="#8b5cf6" strokeWidth={hoverId === 'cus-auto' ? 4 : 2.5} /><text className="supply-icon" y="9" textAnchor="middle" fill="#8b5cf6">person</text><text className="supply-label" y="54" textAnchor="middle">自動車メーカー</text><text className="supply-sublabel" y="72" textAnchor="middle">国内・海外</text></g>
        <g className={nodeClass('cus-elec', ['log-yard'])} onMouseEnter={() => setHoverId('cus-elec')} onMouseLeave={() => setHoverId(null)} transform="translate(820, 320)"><circle r="30" fill="#ffffff" stroke="#8b5cf6" strokeWidth={hoverId === 'cus-elec' ? 4 : 2.5} /><text className="supply-icon" y="9" textAnchor="middle" fill="#8b5cf6">person</text><text className="supply-label" y="54" textAnchor="middle">電機・電子</text><text className="supply-sublabel" y="72" textAnchor="middle">国内・アジア</text></g>
        <g className={nodeClass('cus-gen', ['log-yard', 'log-service'])} onMouseEnter={() => setHoverId('cus-gen')} onMouseLeave={() => setHoverId(null)} transform="translate(820, 460)"><circle r="30" fill="#ffffff" stroke="#8b5cf6" strokeWidth={hoverId === 'cus-gen' ? 4 : 2.5} /><text className="supply-icon" y="9" textAnchor="middle" fill="#8b5cf6">person</text><text className="supply-label" y="54" textAnchor="middle">一般産業</text><text className="supply-sublabel" y="72" textAnchor="middle">国内中心</text></g>
      </svg>
    </div>
  );
}
